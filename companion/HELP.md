...
> **Note (SLX-D+):** SLX-D+ receivers block TCP control by default — enable it on the device under `Device Configuration > Device Settings > Controller Access > Allow`.
